...
def llegada(STP: list, TPLL: list, TPS: list, k: list, T: list, NS: list, N: int, STA: list, STO: list, CTO: list, lamda: float, mu: float , arrepentidos: int):
    """
    ...
    if tratar_arrepentimiento(TPLL[k], T, 300): # Se arrepiente
       arrepentidos += 1
       return
    
    # En caso de que entre al sistema
    NS[p] += 1
